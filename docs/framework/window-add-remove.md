...
![WindowManager 体系架构](/img/android/window-add-remove/01_wm_architecture.svg)
...
![APP 进程和 WMS 系统进程的关系](/img/android/window-add-remove/02_app_wms_relationship.svg)

## WindowManager 如何进行对 Window 管理

### 相关类

![WindowManager 相关类 UML 图](/img/android/window-add-remove/03_class_diagram.svg)
...
![Context 类层次](/img/android/window-add-remove/04_context_hierarchy.svg)
...
![addView 时序图](/img/android/window-add-remove/05_addview_sequence.svg)
